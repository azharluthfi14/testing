...
import {
    ...
    RESET_CHANGE_FORGOT_PASSWORD_STATE,
} from './constants';
...
export interface resetForgotPasswordState {
    type: typeof RESET_CHANGE_FORGOT_PASSWORD_STATE;
}
...
export const resetForgotPasswordState = (): resetForgotPasswordState => ({
    type: RESET_CHANGE_FORGOT_PASSWORD_STATE,
});
