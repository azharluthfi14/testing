...
export const en = {
    ...
    'page.body.landing.marketInfo.title.text1': 'Welcome to Koinku.',
    ...
    'page.body.landing.register.item.text': 'Koinku offers an intuitive interface with real time orderbooks, charting tools, trade history, and a simple order process so you can trade from day one.',
    'page.body.landing.register.item.button': 'register',

    'page.body.landing.features.title': 'Koinku platform features',
    ...
    'page.body.landing.features.features.item1.text': 'Koinku offers the most liquid order book in the world, allowing users to easily exchange Bitcoin, Ethereum, EOS, Litecoin, Ripple, NEO and many other digital assets with minimal slippage.',
    'page.body.landing.features.features.item2.text': 'Koinku offers a suite of order types to give traders the tools they need for every scenario. Discover more about our most advanced Algorithmic orders types.',
    ...
    'page.body.landing.tradeOnTheGo.item.text3': 'All the power of Koinku cryptocurrency exchange, in the palm of your hand.',
    ...
    'page.body.landing.footer.rights': 'Koinku © All rights reserved.',
    ...
    'success.confirm.code.created': 'You account has been activated, Please login',
    ...
    'page.body.wallets.beneficiaries.addAddressModal.body.coinBeneficiaryName': 'Label Name',
    ...
    'page.body.wallets.beneficiaries.addAddressModal.body.fiatName': 'Label Name',
 ...
 If you forget you Secret Key, please delete it and apply for a new Secret Key pair.`,
    ...
    'page.body.kyc.documents.uploadFile.front.label': 'Take a photo of front of your Identity Card',
    ...
    'page.body.kyc.documents.uploadFile.selfie.label': 'Please take a selfie, we will compare the photo in your identity card with your face',
    ...
    'identity.user.utilized_token': 'Please enter a valid code',
    ...
    'account.withdraw.not_permitted': 'Please, pass the corresponding verification steps',
    ...
    'account.withdraw.create_error': 'Failed to create withdraw, Please wait for 1 minute',
    ...
    'market.trade.not_permitted': 'Please, pass the corresponding verification steps',
    ...
    'resource.user.missing_password' : 'Please provide a valid password',
    'resource.user.empty_password' : 'Please provide a valid password',
    'resource.user.invalid_password' : 'Please provide a correct password',
    'resource.user.empty_otp_code': 'Please provide 6 Digits authenticator code',
    'resource.user.invalid_otp': 'Your authentication code is wrong',
