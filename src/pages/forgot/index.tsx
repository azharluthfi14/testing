...
interface DispatchProps {
  ...
  resetForgotPasswordState: typeof resetForgotPasswordState;
}
...
class Forgot extends React.Component<Props, ForgotPasswordState> {
  ...
  public componentDidUpdate(prevProps: Props) {
    ...
    if (success === true && this.state.email) {
      history.push({
    ...
    return (
      <IonPage>
        <EmailForm
          ...
          onGoBack={() => this.props.history.push("/login")}
        />
      </IonPage>
    );
  }
...
)(Forgot) as React.ComponentClass;
